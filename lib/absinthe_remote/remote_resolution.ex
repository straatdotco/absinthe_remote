defmodule AbsintheRemote.RemoteResolution do
  @moduledoc """
  ...
  defp perform_resolution(bp_root, operation, options) do
    ...
    # This is the only custom logic of RemoteResolution
    # It's only goal is to add data that is not available inside of hydration

    private =
      Map.merge(res.private, %{raw_source: bp_root.source, operation_name: operation.name})

    res = %{res | private: private}
    # End custom logic
